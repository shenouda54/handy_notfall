...
//   try {
//
//     final docRef = await FirebaseStorage.instance.collection("customers").add(customerData);
//
//
//     await docRef.update({'customerCode': docRef.id});
//
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Customer data saved successfully!')),
//     );
//   } catch (e) {
//     ScaffoldMessenger.of(context).showSnackBar(
